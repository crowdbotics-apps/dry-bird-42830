"""
Django settings for dry_bird_42830 project.
...
ROOT_URLCONF = 'dry_bird_42830.urls'
...
WSGI_APPLICATION = 'dry_bird_42830.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_bird_42830 API",
    "DESCRIPTION": "API documentation for dry_bird_42830 App",
    "VERSION": "v1",
}
